...
<body>
        <form action="tambah/prosesTambahOutlet.php" method="POST" class="bg-gray-600 max-w-xl mx-auto p-10 mt-5 rounded-md">
    ...
    <input type="text" id="alamatOutlet" name="alamat" rows="5" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 p-2" placeholder="Isi Alamat Outlet">
  </div>
