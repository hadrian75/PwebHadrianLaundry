<?php 
                         $id = 1;
                         $datas = mysqli_query($koneksi, "SELECT * FROM tb_member");
    ...
    <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
        ...
        ?>
                        <tr class="border-b dark:border-gray-700">
                            ...
                            ">
                <a href="<?php if(!$hasConnections) { echo 'dashboard.php?page=deleteMember&id=' . $data['id']; } ?>" class="<?php if($hasConnections) { echo "disabled aria-disabled='true' cursor-not-allowed w-full h-auto  "; } ?>">Delete</a>
                         </button>
                        </td>
                        </tr>
