<?php 
                         $id = 1;
                         $datas = mysqli_query($koneksi, "SELECT * FROM tb_outlet");
    ...
    <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
        ...
        ?>
                        <tr class="border-b dark:border-gray-700">
                            ...
                            ">
                <a href="<?php if(!$hasConnections) { echo 'delete/deleteOutlet.php?id='. $data['id']; } ?>" class="px-5 py-2.5 <?php if($hasConnections) { echo "cursor-not-allowed w-full h-auto "; } ?>">Delete</a>
                         </button>
                        </td>
                        </tr>
